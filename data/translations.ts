...
export const TRANSLATIONS = {
    zh: {
        ...
        label_ltv: "按揭成數 (%)",
        label_rate: "年利率 (%)",
        label_new_loan: "新造按揭融資",
        label_lower: "較低",
        label_recommended: "建議方案",
        label_tenure: "按揭年期 (年)",
        label_reserve: "流動資金儲備",
        label_cash: "現金",
        label_own_cash: "投入現金",
        label_full_paid: "全數付清",
        label_remortgage: "重新按揭",
        label_outstanding_loan: "現有按揭餘額",
        status_hibor_live: "實時同步",
    ...
    en: {
        ...
        label_new_loan: "New Mortgage Amount",
        label_lower: "Lower",
        label_recommended: "Recommended",
        label_tenure: "Loan Tenure (Years)",
        label_reserve: "Liquidity Reserve",
        label_cash: "Cash",
        label_own_cash: "Cash Investment",
        label_full_paid: "Full Paid",
        label_remortgage: "Remortgage",
        label_outstanding_loan: "Outstanding Loan",
        status_hibor_live: "Live",
